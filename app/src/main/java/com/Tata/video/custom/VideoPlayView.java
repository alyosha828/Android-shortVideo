...
public class VideoPlayView extends FrameLayout implements View.OnClickListener, ITXVodPlayListener {
    ...
    //    mPlayer.setPlayListener(mPlayListener);
        ...
        mPlayer.setConfig(mTXPlayConfig);
    ...
    private void videoSizeChanged(int width, int height) {
        Log.e(TAG, "#videoSizeChanged---width--->" + width);
        Log.e(TAG, "#videoSizeChanged---height-->" + height);
    ...
    public void setPlayWrap(VideoPlayWrap wrap) {
        mPlayWrap = wrap;
        Log.e(TAG, "#setPlayWrap------->" + wrap.hashCode());
    }
