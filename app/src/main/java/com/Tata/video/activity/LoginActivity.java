...
public class LoginActivity extends AbsActivity implements OnItemClickListener<ShareBean> {
    ...
    protected void main() {
        ...
        Log.e("#LoginActivity", "#设备编号：----->" + mDevice);
    ...
    private void login() {
        ...
        Log.e("code = ",  code + " , SIGN_1 = " + Constants.SIGN_1 + "  , mobile == " + mobile + " , SIGN_2 = " + Constants.SIGN_2 + " , -getDecryptSign()==-- "
                + AppConfig.getInstance().getConfig().getDecryptSign() + " , -SIGN_3==-- " + Constants.SIGN_3);

        Log.e("MD5Util Url 1 === ", s);
        s = MD5Util.getMD5(s);
        Log.e("MD5Util Url 2 === ", s);
    ...
    private void getLoginCode() {
        ...
        Log.e("getLoginCode 1 === ", AppConfig.getInstance().getConfig().getDecryptSign());
        ...
        Log.e("getLoginCode 2 === ", s);
        s = MD5Util.getMD5(s);
        Log.e("getLoginCode 3 === ", s);
    ...
    private void thirdLogin() {
        ...
        mSharedSdkUitl.login(mThirdLoginType, new SharedSdkUitl.ShareListener() {
            ...
            public void onSuccess(Platform platform) {
                ...
                Toast.makeText(mContext, getString(R.string.login_auth_success), Toast.LENGTH_LONG).show();
            ...
            public void onError(Platform platform) {
                ...
                Toast.makeText(mContext, getString(R.string.login_auth_failure), Toast.LENGTH_LONG).show();
            }

            @Override
            public void onCancel(Platform platform) {
               // ToastUtil.show(getString(R.string.login_auth_cancle));
                Toast.makeText(mContext, getString(R.string.login_auth_cancle), Toast.LENGTH_LONG).show();
            }
