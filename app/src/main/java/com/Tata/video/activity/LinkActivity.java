...
public class LinkActivity extends AbsActivity implements View.OnClickListener {
    ...
    private void toNext() {
        ...
        if (TextUtils.isEmpty(url)) {
            ...
            Toast.makeText(mContext, getResources().getString(R.string.请输入视频链接), Toast.LENGTH_LONG).show();
            return;
        }
            ...
            public void onSuccess(int code, String msg, String[] info) {
                if (code == 0 && info.length > 0) {
                    ...
                    if (code == 1003) {
                        ...
                        Toast.makeText(mContext, getResources().getString(R.string.该视频已被使用), Toast.LENGTH_LONG).show();
                    } else {
                        //ToastUtil.show(getResources().getString(R.string.获取视频链接失败));
                        Toast.makeText(mContext, getResources().getString(R.string.获取视频链接失败), Toast.LENGTH_LONG).show();
                    }
                    if (mDialog != null) {
                        mDialog.dismiss();
                    }
    ...
    private void downloadVideo() {
        ...
        new DownloadUtil().download(mTag, AppConfig.VIDEO_PATH, fileName, mResultVideoUrl, new DownloadUtil.Callback() {
            ...
            public void onSuccess(File file) {
                ...
                Toast.makeText(mContext, WordUtil.getString(R.string.download_success), Toast.LENGTH_LONG).show();
                if (mDialog != null) {
                    mDialog.dismiss();
                }
            ...
            public void onError(Throwable e) {
                ...
                Toast.makeText(mContext, WordUtil.getString(R.string.download_fail), Toast.LENGTH_LONG).show();
                if (mDialog != null) {
                    mDialog.dismiss();
                }
            }
