                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (cutResult.exists() && cutResult.length() > 0) {
                                ...
                                Toast.makeText(mContext, WordUtil.getString(R.string.cut_music_failed), Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                }
                ...
                HttpUtil.addMyMusic(mTitle, length, url, new HttpCallback() {
                    ...
                    public void onSuccess(int code, String msg, String[] info) {
                        if (code == 0) {
                            ...
                            Toast.makeText(mContext, R.string.音乐已上传至后台审核+"，\n"+R.string.审核通过则自动加入音乐库, Toast.LENGTH_LONG).show();
                        }
                    }
