...
public class VideoPublishActivity extends AbsActivity implements OnItemClickListener<ShareBean>, View.OnClickListener {
    ...
    private void publishVideo() {
        ...
        Log.e("#saveUploadInfo","1== " + mVideoUploadBean.getImgName() + " == " + mVideoUploadBean.getVideoName());
    ...
    private void saveUploadInfo() {
        ...
        Log.e("#saveUploadInfo","2== " + mVideoUploadBean.getImgName() + " == " + mVideoUploadBean.getVideoName());
